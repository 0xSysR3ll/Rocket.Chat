...
// import { license } from '../../../ee/app/api-enterprise/server/middlewares/license'; // Removed for FOSS
		...
		subpaths.forEach((route) => {
			...
			Object.keys(operations).forEach((method) => {
				...
				this.router[method.toLowerCase() as 'get' | 'post' | 'put' | 'delete'](
					...
					// license(_options as TypedOptions, License), // FOSS: License check disabled
