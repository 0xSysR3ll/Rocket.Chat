...
// import { Utilities } from '../../../ee/lib/misc/Utilities'; // Removed for FOSS
...
// Stub for Utilities class in FOSS version
const Utilities = {
	getI18nKeyForApp: (key: string, appId: string) => `${appId}.${key}`,
};
